<?php /* Smarty version Smarty-3.1.19, created on 2016-04-02 09:04:55
         compiled from "/home/ngoinhat/public_html/themes/default-bootstrap/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:91370870556ff28c7e00248-56451517%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff1bf191dd67551d21cf652aecf8f5c8777da7ea' => 
    array (
      0 => '/home/ngoinhat/public_html/themes/default-bootstrap/product-list.tpl',
      1 => 1458656362,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '91370870556ff28c7e00248-56451517',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56ff28cab0ca17_66013161',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56ff28cab0ca17_66013161')) {function content_56ff28cab0ca17_66013161($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/ngoinhat/public_html/tools/smarty/plugins/function.math.php';
?>
							...
							<span class="availability">
								<?php if (($_smarty_tpl->tpl_vars['product']->value['allow_oosp']||$_smarty_tpl->tpl_vars['product']->value['quantity']>0)) {?>
									<span class="<?php if ($_smarty_tpl->tpl_vars['product']->value['quantity']<=0&&isset($_smarty_tpl->tpl_vars['product']->value['allow_oosp'])&&!$_smarty_tpl->tpl_vars['product']->value['allow_oosp']) {?> label-danger<?php } elseif ($_smarty_tpl->tpl_vars['product']->value['quantity']<=0) {?> label-warning<?php } else { ?> label-success<?php }?>">
										...
										<?php if (isset($_smarty_tpl->tpl_vars['product']->value['available_later'])&&$_smarty_tpl->tpl_vars['product']->value['available_later']) {?><?php echo $_smarty_tpl->tpl_vars['product']->value['available_later'];?>

										<?php } else { ?><?php echo smartyTranslate(array('s'=>'In Stock'),$_smarty_tpl);?>
<?php }?>
										<?php } else { ?><?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
<?php }?>
										<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['product']->value['available_now'])&&$_smarty_tpl->tpl_vars['product']->value['available_now']) {?>
